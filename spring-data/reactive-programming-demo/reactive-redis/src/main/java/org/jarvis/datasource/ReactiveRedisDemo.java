...
/**
 * author:marcus date:2020/8/2
 **/
@SpringBootApplication
@Slf4j
public class ReactiveRedisDemo implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        List<org.jarvis.consumer.Coffee> list = jdbcTemplate.query(
                "select * from t_coffee", (rs, i) ->
                        org.jarvis.consumer.Coffee.builder()
                                .id(rs.getLong("id"))
        ...
        Flux.fromIterable(list)
                ...
                .concatWith(redisTemplate.expire(KEY, Duration.ofMinutes(100)))
